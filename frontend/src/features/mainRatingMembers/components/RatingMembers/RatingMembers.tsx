...
import RatingMembersSkeleton from '@/features/mainRatingMembers/components/RatingMembers/RatingMembersSkeleton';
...
const RatingMembers: React.FC<Props> = ({ ratingMembers, isFetching, title, category }) => {
  return (
    <>
      {isFetching ? (
        <RatingMembersSkeleton />
      ) : (
        <>
