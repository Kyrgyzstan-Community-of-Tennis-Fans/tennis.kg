...
import { fetchUsers, updateRole } from '@/features/users/usersThunks';
            ...
            {users.map((user) => (
              <TableRow key={user._id}>
                ...
                <TableCell className={'w-[160px] flex gap-2'}>
                  ...
                  <InfoTip text={'Поменять роль пользователю'} delay={300} className={'border border-muted-foreground'}>
                    <Button
                      size={'icon'}
