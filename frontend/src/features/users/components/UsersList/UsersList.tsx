...
import { selectUserPermission, selectUsersList, selectUsersListPages } from '@/features/users/usersSlice';
import { fetchUsers, updateIsActive, updateRole } from '@/features/users/usersThunks';
...
export const UsersList = () => {
  ...
  const toggleModeration = async (id: string) => {
              ...
              {users.map((user) => (
                <TableRow key={user._id}>
                  ...
                  <TableCell className={'w-[160px] flex gap-2'}>
                    ...
                    {userPermission === 3 && (
                      <InfoTip
                        text={'Поменять роль пользователю'}
                        delay={300}
                      ...
                      >
                        <Button
                          ...
                          className={'font-normal'}
                          variant={'secondary'}
                          onClick={() => toggleModeration(user._id)}
                        >
