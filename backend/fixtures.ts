...
const run = async () => {
  ...
  await User.create(
    ...
    },
    {
      ...
      category: proMasters._id,
      fullName: 'Alice Doe',
      telephone: '0999 999 992',
      dateOfBirth: '15.12.2004',
      gender: 'female',
      password: '123qwe',
      email: 'aice@gmail.com',
      token: randomUUID(),
    },{
      category: proMasters._id,
      fullName: 'Alice Doe',
      telephone: '0999 999 111',
      dateOfBirth: '15.12.2004',
      gender: 'female',
      password: '123qwe',
